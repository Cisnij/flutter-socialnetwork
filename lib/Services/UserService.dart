...
class UserService{
  ...
  Future<http.Response> userInformation() async{
    return await authGet(url: 'http://172.17.17.98:8000/api/user/');
  }
  Future<http.Response> userPost(int id) async{
    return await authGet(url: 'http://172.17.17.98:8000/api/user/post/userpage/$id/');
  }
  Future<http.Response> viewPage(int id) async{
    return await authGet(url: 'http://172.17.17.98:8000/api/auth/profile/userpage/$id');
  }
  ...
  Future<http.Response> search(String name) async{
    return await authGet(url: 'http://172.17.17.98:8000/api/user/profile/?last_name=$name');
  }
}